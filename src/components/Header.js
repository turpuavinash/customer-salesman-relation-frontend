...
const Header = () => {
  ...
  <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Farmconnect</span>
  </Link>
  <div className="flex md:order-2">
    ...
    <div className={`${hidden?"hidden":""} items-center justify-between w-full md:flex md:w-auto md:order-1`} id="navbar-search">
      ...
      <li>
        ...
        <li>
          <NavLink to="farm/farmdetails" className={({isActive})=> isActive ? activeClass : inActiveClass} >FarmDetails</NavLink>
        </li>
        <li>
          <NavLink to="farm/milkdetails" className={({isActive})=> isActive ? activeClass : inActiveClass} >MilkDetails</NavLink>
        </li>
        <li>
          <NavLink to="farm/payments" className={({isActive})=> isActive ? activeClass : inActiveClass} >Payments</NavLink>
        </li>
        <li>
          <NavLink to="farm/productsdispatched" className={({isActive})=> isActive ? activeClass : inActiveClass} >ProductsDispatched</NavLink>
        </li>
      </ul>
    </div>
  </div>
